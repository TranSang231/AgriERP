      ...
      <div class="flex justify-between items-center mb-6">
        <div>
          <h1 class="text-2xl font-bold text-gray-900">
            {{ isEdit ? t('Edit Customer') : t('Add New Customer') }}
          </h1>
          <p class="text-gray-600 mt-1">{{ t('Manage e-commerce customer information') }}</p>
        </div>
...
const isEdit = computed(() => !!customerId && customerId !== 'new')
...
const submitForm = async () => {
  ...
  try {
    ...
    if (isEdit.value) {
      ...
      ElMessage.success(t('Customer created successfully'))
    }
